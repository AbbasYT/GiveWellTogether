        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">How is my money distributed?</h3>
              <p className="text-gray-700">
                Your monthly subscription is divided equally among all verified partner organizations. 
                We update the distribution monthly as new organizations join our platform.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">How do you verify organizations?</h3>
              <p className="text-gray-700">
                All organizations go through a rigorous verification process including financial audits, 
                impact assessments, and ongoing monitoring to ensure your donations create real change.
              </p>
            </div>
            
            <div className="bg-white p-8 rounded-xl">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">What about privacy and data security?</h3>
              <p className="text-gray-700">
                We take your privacy seriously. Your personal information is encrypted and never shared 
                with third parties. You control what information is visible in impact reports.
              </p>
            </div>
          </div>
        </div>
