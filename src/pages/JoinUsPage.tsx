          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Transparent Funding</h3>
                <p className="text-gray-300 text-sm">Equal distribution ensures fair support for all verified partners</p>
              </div>
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
                <Users className="h-12 w-12 text-green-400 mx-auto mb-4" />
                <h3 className="text-lg font-bold text-white mb-2">Growing Community</h3>
                <p className="text-gray-300 text-sm">Connect with a network of dedicated donors and fellow organizations</p>
              </div>
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
                <Globe className="h-12 w-12 text-purple-400 mx-auto mb-4" />
                <h3 className="text-lg font-bold text-white mb-2">Global Reach</h3>
                <p className="text-gray-300 text-sm">Expand your impact beyond traditional fundraising boundaries</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-6">Our Verified Partners</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Meet the organizations that have joined our mission. Click on any card to learn more about their work and impact.
              </p>
            </div>
            ...
            {applications.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-lg">No approved organizations yet. Be the first to join our mission!</p>
              </div>
            ) : (
