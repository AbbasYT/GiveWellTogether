  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl">
        ...
        <button className="w-full bg-slate-700 hover:bg-slate-800 text-white py-3.5 rounded-2xl font-medium transition-colors mb-6 flex items-center justify-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 py-3.5 rounded-2xl font-medium transition-colors disabled:opacity-50"
          >
